...
| # | File | What it covers |
|---|------|----------------|
| 1 | [build-system.md](build-system.md) | How `makebuild.sh` builds the ISO from scratch |
| 2 | [iso-structure.md](iso-structure.md) | Layout of the final ISO and boot process |
...
| 10 | [grub-boot.md](grub-boot.md) | GRUB bootloader configuration |
| 11 | [customization.md](customization.md) | How to customize using the `customize/` directory |
| 12 | [shell-env.md](shell-env.md) | Bash prompt, aliases, inputrc, and user experience |
